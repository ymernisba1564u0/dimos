...
- [**C#**](https://github.com/dimensionalOS/dimos-lcm/tree/main/generated/csharp)
- [**Java**](https://github.com/dimensionalOS/dimos-lcm/tree/main/generated/java)

For pubsub client implementation, look into the [LCM Project](https://github.com/lcm-proj/lcm).

Generally LCM is a very simple protocol that's easy to implement in any language, and our types are [autogenerated](https://github.com/dimensionalOS/dimos-lcm/)
